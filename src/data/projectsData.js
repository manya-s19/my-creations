const projectsData = [
  ...
  },
  {
    ...
    description: "Advanced simulation system for Global Navigation Satellite Systems (GNSS) that models satellite orbits, signal propagation, and positioning algorithms for research and education.",
